...
susannah = User.create(email: "susannah@email.com", password: "123456", username: "susannahtay", location: "Shoreditch, London", name: "Susannah", age: 25, favourite: "Cycling")
molka = User.create(email: "molka@email.com", password: "123456", username: "molka1", location: "London Bridge, London", name: "Molka", age: 30, favourite: "Yoga")
...
fiorella = User.create(email: "fiorella@email.com", password: "123456", username: "sajifio", location: "London Fields, London", name: "Fiorella", age: 24, favourite: "Running")
andrea = User.create(email: "andrea@email.com", password: "123456", username: "AAATL", location: "Hackney Central, London", name: "Andrea", age: 24, favourite: "Pilates")
...
luiza = User.create(email: "luiza@email.com", password: "123456", username: "l-p-n", location: "Pimlico, London", name: "Luiza", age: 25, favourite: "Football")
kassra =  User.create(email: "kassra@email.com", password: "123456", username: "kazthemaz", location: "Whitehall, London", name: "Kassra", age: 25, favourite: "Hot yoga")
ben =  User.create(email: "ben@email.com", password: "123456", username: "benmclaren", location: "Islington, London", name: "Ben", age: 25, favourite: "Hot yoga")
